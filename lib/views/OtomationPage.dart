...
class _OtomationPageState extends State<OtomationPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          buildListTile(Colors.green,Colors.green,'assets/icons/drill.png',"SCOREN"),
          buildListTile(Colors.green,Colors.green,'assets/icons/lamb.png',"I-Light"),
          buildListTile(Colors.red,Colors.red,'assets/icons/driller.png',"ShaveArt"),
        ],
      ),
    );
  }
/*'assets/icons/drill.png'*/
  Padding buildListTile(Color glowColor,Color iconColor,String iconPath,String text) {
    return Padding(
